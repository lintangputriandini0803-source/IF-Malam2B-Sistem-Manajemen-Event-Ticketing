...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('panitia.settings') }}" class="nav-item {{ request()->routeIs('panitia.settings') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('panitia.scan.index') }}" class="nav-item {{ request()->routeIs('panitia.scan.index') ? 'active' : '' }}">
